...
(curl -LO raw.githubusercontent.com/prateekrajput08/Arcade-Google-Cloud-Labs/blob/main/Extract%2C%20Analyze%2C%20and%20Translate%20Text%20from%20Images%20with%20the%20Cloud%20ML%20APIs/sign.jpg > /dev/null 2>&1) &
